...
class FinderBase {
  ...
  get isAllowedNotFound(){ return this._allowNotFound }
  allowNotFound(val){ this._allowNotFound = val; return this; }
  /**
  ...
  clone(callback){
    const cloned = Object.assign(new this.constructor(this.page), {
      ...
      _allowNotFound: this.isAllowedNotFound,
      _action: this.action,
